...
if strcmp(EyeTracker_Type, 'iViewX')
    ...
    %sent to from 192.168.1.8 to whatever the IP address is for this connection
    %(found in Network, mine is 192.168.1.200)
    %
...
elseif strcmp(EyeTracker_Type, 'FrameGrabber')
    ...
    server_IP = '169.254.152.238';  % What is the IP address of the destination computer (Use ifconfig (mac) or ipconfig /all (windows) to find this out)
